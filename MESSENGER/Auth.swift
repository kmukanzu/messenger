    ...
    override func viewDidLoad() {
        ...
        let alertActionForTextField = UIAlertAction(title: "Sign up", style: .Default) { (action) -> Void in
            ...
            if let textFields = self.newAccountAlert?.textFields {
                ...
                if fullNameTextField != "" && emailTextField != "" && passwordTextField != "" && emailTextField?.characters.indexOf("@") != nil && emailTextField?.characters.indexOf(".") != nil && emailTextField?.rangeOfString(".com") == nil && self.userName.rangeOfString(".") == nil {
